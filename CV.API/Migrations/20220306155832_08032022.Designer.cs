...
namespace CV.API.Migrations
{
    ...
    [Migration("20220306155832_08032022")]
    partial class _08032022
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CV.API.Domain.Entities.CSSContent", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("CV.API.Domain.Entities.Language", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CV.API.Domain.Entities.CSSContent", b =>
                {
                    b.HasOne("CV.API.Domain.Entities.Template", null)
                        .WithMany("CSSContents")
